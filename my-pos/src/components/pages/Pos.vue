                        ...
                        <el-tab-pane label="点餐">
                            ...
                            <el-table-column label="操作" width="100" fixed="right">
                                <template scope="scope">
                                    <el-button type="text" size="small" @click="delectSingleGoods(scope.row)">删除</el-button>
                            ...
                            <div class="order-btn">
                                ...
                                <el-button type="danger" @click="delectAllgoods">删除</el-button>
                ...
                <el-col :span="17">
                    <div class="often-goods">
                        ...
                        <div class="often-goods-list">
                            <ul>
                                <li v-for="good in oftenGoods" :key="good.goodsId" @click="addGoodslist(good)">
                    ...
                    <div class="goods-type">
                        <el-tabs>
                            <el-tab-pane label="汉堡">
                                <ul class='cookList'>
                                    <li v-for="good in type0Goods" :key="good.goodsId" @click="addGoodslist(good)">
    ...
    export default {
        ...
        methods: {
            ...
            addGoodslist(item) {
                ...
                if(isHave) {
                    let arr = this.tableData.filter(res => res.goodsId == item.goodsId)
                    arr[0].count++;
                } else{
                    let good = { goodsId:item.goodsId,goodsName:item.goodsName,price:item.price,count:1};
                    this.tableData.push(good);
                }
                this.getAllmoney();
            },
            //删除单个商品
            delectSingleGoods(item) {
            ...
            check() {
                ...
                this.$message({
                    message: `结账成功，今天营业额${this.totalMoney}元`,
                    type: 'success'
                });
                this.tableData = [];
                this.totalCount = 0;
